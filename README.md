...
This repository contains the actual implementation of my smart home system. However, it can be considered as an example to build your own.
The [UseCases](UserCases) directory is likely the most useful part as it contains step-by-step tutorials with clear explanations of typical use cases for
the Domestik suite (*until I find the time to create a proper website for it*).
